...
void run_diehard_operm5()
{
  ...
  */
 show_test_header(&diehard_operm5_dtest,diehard_operm5_test);
  ...
  */
 std_test(&diehard_operm5_dtest,diehard_operm5_test);
  ...
  */
 show_test_results(&diehard_operm5_dtest,diehard_operm5_test);
 fflush(stdout);

 /*
  * Destroy the test and free all dynamic memory it used.
  */
 destroy_test(&diehard_operm5_dtest,diehard_operm5_test);
